...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogPR";
    static String forumTableName = "ForumPR";
    static String threadTableName = "ThreadPR";
    static String replyTableName = "ReplyPR";
